...
function mt(){
	...
	//内页设计
	if ($('#md_detailProductClass').length) {
        $(document).ready(function() {
            $('#md_detailProductClass li.ac .first').attr('href', 'javascript:;');
            var dd = $('#md_detailProductClass li.ac').find('.gg');
            if(dd.hasClass('gg')){
                var thisobj = dd;
                var AH =thisobj.find('a').height();
                var BoxH = thisobj.find('a').length * AH;
            ...
            $('#md_detailProductClass li.ac').on('click', function() {
                var thisobj = $(this).find('.classBox');
                var AH = $(this).find('a').height();
                var BoxH = thisobj.find('a').length * AH;
                if (thisobj.hasClass('ac')) {
